...
<main class="form-container" style="max-width: 700px;">
    ...
    <form action="{{ route('admin.tickets.update', $ticket->id) }}" method="POST">
        ...
        <a href="{{ route('admin.tickets.index') }}" class="button" style="background-color: #555; width: auto; padding: 12px 30px; margin-top: 20px; display: block; text-align: center;">Kembali ke Daftar Tiket</a>
    </form>
</main>
@endsection